...
module.exports = {
  up(queryInterface) {
    ...
    candidatesData.push({
      ...
      slogan: "Se Vienen Tiempos Mejores",
    ...
    candidatesData.push({
      ...
      bio: "Alejandro René Eleodoro Guillier Álvarez (La Serena, 5 de marzo de 1953) es un sociólogo, periodista y político chileno independiente. ​ Es senador por la II Circunscripción de Antofagasta y candidato presidencial de los partidos Radical, Socialista, Comunista, por la Democracia, MAS Región e Izquierda Ciudadana.4",
    ...
    candidatesData.push({
      ...
      slogan: "Queremos Cambios Profundos",
